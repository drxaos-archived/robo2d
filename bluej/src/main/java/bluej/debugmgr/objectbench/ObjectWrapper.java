...
public class ObjectWrapper extends JComponent implements Accessible, FocusListener, InvokeListener, KeyListener, NamedValue {
    ...
    public static final int WIDTH = objectImage != null ? objectImage.getWidth(null) : 0;    // width including gap
    public static final int HEIGHT = objectImage != null ? objectImage.getHeight(null) : 0;   // height including gap
