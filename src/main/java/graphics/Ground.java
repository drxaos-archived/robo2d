    ...
    public static void initGround() {
        ...
        for (int i = -6; i < 6; i++) {
            for (int j = -3; j < 3; j++) {
                ...
                GL11.glVertex3f(i * 100f, j * 100f, 50f * (float) Math.random());

                GL11.glNormal3f(0, 0, 1f);
                GL11.glTexCoord2f(0.5f, 0.0f);
                GL11.glVertex3f((i + 1) * 100f, j * 100f, 50f * (float) Math.random());

                GL11.glNormal3f(0, 0, 1f);
                GL11.glTexCoord2f(0.5f, 0.5f);
                GL11.glVertex3f((i + 1) * 100f, (j + 1) * 100f, 50f * (float) Math.random());

                GL11.glNormal3f(0, 0, 1f);
                GL11.glTexCoord2f(0.0f, 0.5f);
                GL11.glVertex3f(i * 100f, (j + 1) * 100f, 50f * (float) Math.random());
