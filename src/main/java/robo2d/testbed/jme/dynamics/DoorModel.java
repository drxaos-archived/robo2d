package robo2d.testbed.jme.dynamics;
...
public class DoorModel {
    ...
    public DoorModel(AssetManager assetManager) {
        this.assetManager = assetManager;
    }

    public Node createDoor(DoorImpl door) {
        List<Point2D> vert = door.getVertices();
        List<KPolygon> triangulation = door.getTriangulation();
        ...
        Texture tex = assetManager.loadTexture("models/door/" + door.getType() + ".jpg");
        ...
        Node n = new Node("door");
        n.attachChild(spatial);
        n.setUserData("centerZ", center.x);
        n.setUserData("centerX", center.y);
        return n;
    }
